...
function populate() {
  ...
  ui.showQuickAccessInput.checked = settings.showQuickAccess !== false;
  ...
  ui.showNotesNavInput.checked = settings.showNotesNav !== false;
...
function bind() {
  ...
  const checkboxKeys = { showHostsInput:'showHosts', showQuickAccessInput:'showQuickAccess', openInNewTabInput:'openInNewTab', showTabIconInput:'showTabIcon', showProxyNavInput:'showProxyNav', showNotesNavInput:'showNotesNav', showSessionsNavInput:'showSessionsNav', showToolsNavInput:'showToolsNav', accentEnabledInput:'useCustomAccent' };
