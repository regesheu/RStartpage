...
function bind() {
  ...
  const checkboxKeys = { showHostsInput:'showHosts', openInNewTabInput:'openInNewTab', showTabIconInput:'showTabIcon', showProxyNavInput:'showProxyNav', showNotesNavInput:'showNotesNav', showSessionsNavInput:'showSessionsNav', showToolsNavInput:'showToolsNav', accentEnabledInput:'useCustomAccent' };
