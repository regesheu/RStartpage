...
const RNotes = (() => {
  ...
  return { NOTES_LOCAL_KEY, SYNC_KEY, SYNC_LIMIT, cleanNote, listNotes, listGroups, getSyncUsage, saveNote, setSync, removeNote, saveGroup, removeGroup, exportNotes, importNotes, savePendingDraft, takePendingDraft };
})();
