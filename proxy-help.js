...
const COPY = {
  en: {
    ...
    authTitle: 'Passwords and sync', authText: 'Profiles and rules sync through Chrome Sync. Passwords stay on this device unless you explicitly enable password sync.', authOne: 'Avoid password sync on shared Chrome profiles.', authTwo: 'JSON export excludes passwords by default.', authThree: 'Treat an export with passwords as a secret file.',
  ...
  ru: {
    ...
    authTitle: 'Пароли и синхронизация', authText: 'Профили и правила синхронизируются через Chrome Sync. Пароли остаются на устройстве, пока вы явно не включите их синхронизацию.', authOne: 'Не синхронизируйте пароль в общем профиле Chrome.', authTwo: 'По умолчанию JSON-экспорт не содержит паролей.', authThree: 'Файл экспорта с паролями следует хранить как секретный.',
