...
const COPY = {
  ...
  ru: {
    ...
    authTitle: 'Пароли и синхронизация', authText: 'Профили и правила синхронизируются через Chrome Sync. Пароли остаются на устройстве, пока вы явно не включите их синхронизацию.', authOne: 'Не синхронизируйте пароль в общем профиле Chrome.', authTwo: 'Экспорт и импорт находятся в настройках → «Данные». По умолчанию архив не содержит пароли.', authThree: 'Файл экспорта с паролями следует хранить как секретный.',
